...
- estimated_effort_hours is your read of what a competitive application costs this
  team, counting drafting, gathering attachments, and internal review. Give a whole
  number of hours on every opportunity, without exception. Above 10 is a real signal,
    ...
    return {
        ...
        "properties": {
            ...
            "estimated_effort_hours": {
                "type": "integer",
                "description": "Whole hours for a competitive application. Always required "
                               "— estimate from the ask and the award size if the page is "
                               "thin. Never omit or return null.",
            },
